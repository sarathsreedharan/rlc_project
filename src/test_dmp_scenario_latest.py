...
if __name__ == '__main__':
    ...
    lateral_magic_numbers = [-0.009, -0.075, 0.059] #[-0.043, -0.074, 0.039] #[-0.020, -0.071, 0.053] #[-0.015, -0.072, 0.037]
    vertical_magic_numbers = [-0.019, -0.055, 0.093]
    drop_magic_numbers = [-0.029, -0.087, 0.238]
#    drop_magic_numbers = [-0.0, -0.00, 0.15]
    pour_magic_numbers = [0.029, -0.163, 0.148] #[0.0, -0.0, 0.15] #[0.029, -0.163, 0.148] #[0.026, 0.158, 0.132] #[0.026, -0.170, 0.139]
